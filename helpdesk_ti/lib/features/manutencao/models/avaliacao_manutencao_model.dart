...
/// Modelo de Avaliação de Chamado de Manutenção
class AvaliacaoManutencao {
  final String id;
  ...
  final String? executorId; // ID do executor avaliado
  ...
  factory AvaliacaoManutencao.fromFirestore(DocumentSnapshot doc) {
    final data = doc.data() as Map<String, dynamic>;
    return AvaliacaoManutencao(
      id: doc.id,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'tipo': 'manutencao', // Para diferenciar de avaliações TI
    };
  }

  AvaliacaoManutencao copyWith({
    String? id,
    String? chamadoId,
    String? usuarioId,
    String? usuarioNome,
