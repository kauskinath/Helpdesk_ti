package com.suaempresa.helpdesk_ti
...
class MainActivity : FlutterActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Isso impede que apps maliciosos capturem a tela
        window.setFlags(
        ...
        if (isEmulator() || isDebuggable()) {
            ...
            // ou apenas desabilitar funcionalidades sensíveis
            // finish() // Descomente para bloquear completamente
        }
    }
    
    /**
     * Detecta se o app está rodando em um emulador
     * Emuladores são frequentemente usados para engenharia reversa
     */
    ...
    /**
     * Detecta se o app foi modificado para ser debuggable
     * Apps modificados podem ter sido adulterados
     */
